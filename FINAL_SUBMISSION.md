...
- [x] TypeScript SDK implemented to bridge Next.js and Soroban.
- [x] Wallet connection implemented (Freighter, Albedo, xBull).
- [x] Create Invoice Flow fully functional and signing via connected wallet.
- [x] Pay Invoice Flow fully functional and updating contract state.
- [x] Dashboard dynamic charts reading on-chain state accurately.
