  ...
  const getStatusBadge = (status: InvoiceStatus) => {
    switch (status) {
      ...
      case InvoiceStatus.Cancelled:
        return (
          <span className="text-[10px] font-medium uppercase tracking-[0.1em] px-2.5 py-0.5 rounded-[4px] border bg-[#011d1c] text-[#707777] border-[#707777]/30">
            Cancelled
          </span>
        );
      default:
        return (
          <span className="text-[10px] font-medium uppercase tracking-[0.1em] px-2.5 py-0.5 rounded-[4px] border bg-[#012624] text-[#bbc7c6] border-[#bbc7c6]/30">
            Unknown
          </span>
        );
    }
        ...
        <div className="bg-[#003734] rounded-[16px] border border-[#cbfffc]/10 shadow-none flex flex-col overflow-hidden">
          ...
          <div className="p-4 border-b border-[#cbfffc]/10 bg-[#012624] flex flex-col sm:flex-row gap-4 items-center justify-between">
            <div className="relative w-full sm:max-w-xs flex-1">
              <Search
                className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#bbc7c6]"
                size={16}
              />
              <input
                type="text"
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto">
              <div className="flex items-center space-x-2 bg-[#003734] border border-[#cbfffc]/15 rounded-[6px] px-3 py-2 text-xs flex-1 sm:flex-none h-10">
                ...
                >
                  <option value="all" className="bg-[#003734]">
                    All Statuses
                  </option>
                  <option
                    value={InvoiceStatus.Pending.toString()}
                    className="bg-[#003734]"
                  >
                    Pending
                  </option>
                  ...
                  <option
                    value={InvoiceStatus.Cancelled.toString()}
                    className="bg-[#003734]"
                  >
                    Cancelled
                  </option>
              ...
              >
                <option value="date_desc" className="bg-[#003734]">
                  Newest First
                </option>
                <option value="date_asc" className="bg-[#003734]">
                  Oldest First
                </option>
                <option value="amount_desc" className="bg-[#003734]">
                  Highest Amount
                </option>
                <option value="amount_asc" className="bg-[#003734]">
                  Lowest Amount
                </option>
              </select>
            </div>
          ...
          {invoices.length === 0 ? (
            <div className="text-center py-20 px-4">
              ...
              <h3 className="text-2xl font-medium text-[#ffffff] mb-2">
                No invoices yet
              </h3>
              <p className="text-[#bbc7c6] max-w-md mx-auto mb-8 font-normal text-sm">
                You haven&apos;t created any invoices. Get started by creating
                your first invoice and sharing the payment link.
              </p>
                  ...
                  <tbody className="divide-y divide-[#cbfffc]/10">
                    {currentInvoices.map((invoice) => (
                      <tr
                        ...
                        className="hover:bg-[#012624]/60 transition-colors group"
                      >
                        <td className="px-6 py-5">
                          ...
                          <p className="text-[10px] text-[#bbc7c6]/70 font-mono mt-0.5">
                        ...
                        <td className="px-6 py-5">
                          ...
                          <p className="text-[10px] text-[#bbc7c6]/70 font-mono mt-0.5">
                            {invoice.recipient.slice(0, 6)}...
                            {invoice.recipient.slice(-4)}
                          </p>
                        </td>
                        <td className="px-6 py-5 font-medium text-[#fde9ff] text-base font-['Matter',sans-serif]">
                          {(Number(invoice.amount) / 10000000).toFixed(2)}{" "}
                          <span className="text-xs text-[#bbc7c6] font-normal">
                            XLM
                          </span>
                        </td>
                        <td className="px-6 py-5">
                        ...
                        <td className="px-6 py-5 text-right">
                          <div className="flex items-center justify-end space-x-2">
                            <button
                              ...
                              className="p-1.5 rounded-[6px] bg-[#012624] text-[#bbc7c6] hover:text-[#cbfffc] hover:border-[#cbfffc]/30 border border-[#cbfffc]/15 transition-colors flex items-center gap-1 text-xs px-2"
                            >
                            ...
                            <Link href={`/pay/${invoice.id.toString()}`}>
                ...
                {currentInvoices.map((invoice) => (
                  <div key={invoice.id.toString()} className="p-5 space-y-4">
                    ...
                    <div className="flex justify-between items-end pt-2">
                      <div>
                        <p className="text-xs text-[#bbc7c6]/70 mb-2">
                          {new Date(
                            Number(invoice.createdAt),
                          ).toLocaleDateString()}
                        </p>
