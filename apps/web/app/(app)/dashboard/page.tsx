      ...
      <div className="animate-pulse space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          {[1, 2, 3, 4, 5].map((i) => (
            <div
              key={i}
              className="h-32 bg-[#003734] rounded-[16px] border border-[#cbfffc]/10"
            ></div>
          ))}
        </div>
      </div>
    ...
    >
        ...
        <div className="bg-[#003734] rounded-[16px] p-5 border border-[#cbfffc]/10 shadow-none relative group">
          ...
          <div className="mt-4">
            <div className="text-3xl font-medium text-[#fde9ff] font-['Matter',sans-serif]">
              ...
              <span className="text-xs text-[#bbc7c6] font-normal ml-1.5 uppercase">
                XLM
              </span>
            </div>
          </div>
      ...
      >
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-[#003734] rounded-[16px] p-8 border border-[#cbfffc]/10 shadow-none">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-[24px] font-medium text-[#ffffff] flex items-center tracking-[-0.02em]">
                ...
                Revenue Trend{" "}
                <span className="text-xs text-[#bbc7c6] font-normal ml-2 uppercase">
                  (Last 7 Days)
                </span>
              </h2>
            </div>
          ...
          <div className="bg-[#003734] rounded-[16px] p-8 border border-[#cbfffc]/10 shadow-none">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-[24px] font-medium text-[#ffffff] tracking-[-0.02em]">
                Recent Settle Timeline
              </h2>
              <Link href="/invoices">
                ...
                {invoices.slice(0, 4).map((invoice, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className={`absolute top-1 -left-[31px] w-4 h-4 rounded-full border-2 border-[#012624] flex items-center justify-center ${
                          isPaidStatus
                            ? "bg-[#cbfffc]"
                            : isCancelledStatus
                              ? "bg-[#707777]"
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 hover:bg-[#012624]/50 -mx-4 px-4 py-3 rounded-[8px] transition-colors border border-transparent hover:border-[#cbfffc]/10">
                        <div>
                          ...
                          <div className="flex items-center space-x-2 text-xs text-[#bbc7c6] mt-1 font-mono">
                            <span>
                              To: {invoice.recipient.slice(0, 6)}...
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#003734] rounded-[16px] p-8 border border-[#cbfffc]/10 shadow-none relative overflow-hidden">
            ...
            <div className="bg-[#012624] rounded-[12px] p-5 border border-[#cbfffc]/10 space-y-3">
              <div>
                <p className="text-[11px] font-medium text-[#edfffe] uppercase tracking-[0.1em]">
                  Account Coordinates
                </p>
                <p className="font-mono text-xs text-[#cbfffc] break-all mt-1">
          ...
          {/* Quick Actions Panel */}
          <div className="bg-[#003734] rounded-[16px] p-8 border border-[#cbfffc]/10 shadow-none">
            <h2 className="text-[24px] font-medium text-[#ffffff] mb-4 tracking-[-0.02em]">
              Quick Actions
            </h2>
